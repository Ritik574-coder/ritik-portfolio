...
const defaultRepositories: GitHubRepository[] = [
  {
    name: "Snowflake-Data-Engineering-Project",
    description: "End-to-end Snowflake data warehouse featuring structured staging layers, Star Schema marts, and automated Python loading.",
    htmlUrl: "https://github.com/Ritik574-coder/Snowflake-Data-Engineering-Project",
    stars: 16,
    forks: 6,
    language: "Snowflake SQL",
    languages: ["SQL", "Python", "Snowflake"],
  ...
  {
    name: "contentflow-ai",
    description: "AI-assisted pipeline orchestrating multi-platform content publishing with human-in-the-loop approval and Cloudflare D1.",
    htmlUrl: "https://github.com/Ritik574-coder/contentflow-ai",
    stars: 18,
    forks: 8,
    language: "TypeScript",
    languages: ["TypeScript", "LLM Workflows", "Cloudflare D1"],
    updatedAt: new Date(Date.now() - 86400000 * 2).toISOString(),
    productivityScore: 96,
    commitCount: 125,
  },
  {
    name: "aws-data-engineering-lab",
    description: "Comprehensive AWS Data Engineering lab implementing Boto3 scripts, S3 partitioning, Glue catalog, and Athena SQL.",
    htmlUrl: "https://github.com/Ritik574-coder/aws-data-engineering-lab",
    stars: 14,
    forks: 5,
    language: "Python",
    languages: ["Python", "AWS S3", "AWS Glue", "Athena"],
    updatedAt: new Date(Date.now() - 86400000 * 3).toISOString(),
    productivityScore: 95,
    commitCount: 110,
  },
  {
    name: "Great-Minds-Knowledge-Graph",
    description: "Graph-based data system modeling entities, relationships, provenance, and dynamic network traversal.",
    htmlUrl: "https://github.com/Ritik574-coder/Great-Minds-Knowledge-Graph",
    stars: 11,
    forks: 4,
    language: "JavaScript",
    languages: ["JavaScript", "Knowledge Graph", "HTML"],
    updatedAt: new Date(Date.now() - 86400000 * 4).toISOString(),
    productivityScore: 91,
    commitCount: 95,
  },
  {
    name: "Logging-For-Data-Engineers",
    description: "Structured JSON logging, metrics collection, and alerting patterns for data engineering pipelines with Docker and Python.",
    htmlUrl: "https://github.com/Ritik574-coder/Logging-For-Data-Engineers",
    stars: 9,
    forks: 3,
    language: "Python",
